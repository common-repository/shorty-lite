                                        ...
                                        <div class="collapse out form-group" id="ct">
                                            ...
                                            <div class="controls">
                                                <select id="cloaking_type" name="cloaking_type" class="form-control">
                                                    <option
                                                        value="<?php echo SHORTLY_CLOAKING_TYPE_BASIC; ?>" <?php echo selected($this->set_value('cloaking_type'), SHORTLY_CLOAKING_TYPE_BASIC, true); ?>><?php echo SHORTLY_CLOAKING_TYPE_BASIC; ?></option>
                                                    <option
                                                        value="<?php echo SHORTLY_CLOAKING_TYPE_VIRAL; ?>" <?php echo selected($this->set_value('cloaking_type'), SHORTLY_CLOAKING_TYPE_VIRAL, true); ?>><?php echo SHORTLY_CLOAKING_TYPE_VIRAL; ?></option>
                                                </select>
                                            ...
                                            <fieldset class="cloaking_type_child collapse out ">
                                                ...
                                                <div class="controls">
                                                    <select id="bar_position" name="bar_position" class="form-control">
                                                        <option
                                                            value="<?php echo SHORTLY_BAR_POSITION_TOP; ?>" <?php echo selected($this->set_value('bar_position'), SHORTLY_BAR_POSITION_TOP, true); ?>><?php echo SHORTLY_BAR_POSITION_TOP; ?></option>
                                                        <option
                                                            value="<?php echo SHORTLY_BAR_POSITION_BOTTOM; ?>" <?php echo selected($this->set_value('bar_position'), SHORTLY_BAR_POSITION_BOTTOM, true); ?>><?php echo SHORTLY_BAR_POSITION_BOTTOM; ?></option>
                                                    </select>
                                            ...
                                            <div class="controls">
                                                <select id="frame_content" name="frame_content" class="form-control">
                                                    <option
                                                        value="<?php echo SHORTLY_FRAME_CONTENT_VISIBLE; ?>" <?php echo selected($this->set_value('frame_content', SHORTLY_FRAME_CONTENT_HIDDEN), SHORTLY_FRAME_CONTENT_VISIBLE, true); ?>>
                                                        Visible to search engines (index)
                                                    </option>
                                                    <option
                                                        value="<?php echo SHORTLY_FRAME_CONTENT_HIDDEN; ?>" <?php echo selected($this->set_value('frame_content', SHORTLY_FRAME_CONTENT_HIDDEN), SHORTLY_FRAME_CONTENT_HIDDEN, true); ?>>
                                        ...
                                        <div class="collapse out form-group" id="ast">
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="switch btn-group btn-group-sm" data-toggle="buttons-radio" style="margin-bottom:10px;">
                                                        <button type="button" data-value="1"
                                                                class="btn btn-small <?php echo $this->set_value('blank_referrer') == 1 ? 'active' : ''; ?>"
                                                                data-target="#">On
                                                        </button>
                                                        <button type="button" data-value="0"
                                                                class="btn btn-small <?php echo $this->set_value('blank_referrer', 0) == 0 ? 'active' : ''; ?>"
                                                                data-target="#">Off
                                                        </button>
                                                    </div>
