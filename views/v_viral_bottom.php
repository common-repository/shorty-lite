...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function resizeIframe() {
                jQuery("#iframe").height(WindowHeight() - 40);
            }
    ...
    <body>
        ...
        if ($link->cloaking_type == SHORTLY_CLOAKING_TYPE_VIRAL) {
            ...
            <div class="navbar navbar-fixed-bottom <?php echo get_option(SH_PREFIX . 'settings_bar_theme') == SHORTLY_BAR_THEME_BLACK ? 'navbar-inverse' : ''; ?>">
