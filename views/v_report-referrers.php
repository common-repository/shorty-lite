<div class="page-header">
    <h2><i class="fa fa-signal"></i> Referrer Report</h2>
    <p>Referring pages and websites overview <?php echo $date_selection['display_title']; ?>. </p>
</div>

<div class="btn-toolbar">
    <div class="btn-group pull-left">
        <a href="?page=sh_reports_page" class="btn btn-default">Overview</a>
        <a href="?page=sh_reports_page&action=report-referrers" class="btn btn-primary active">Referrers</a>
