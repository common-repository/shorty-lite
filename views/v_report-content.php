...
<div class="header" style="padding:30px 0px; height:auto;">
    <ul class="nav nav-wizard" style="margin:0px;">
        ...
        <a href="?page=sh_reports_page&action=report-campaign&source=<?php echo $_GET['source']; ?>&medium=<?php echo $_GET['medium']; ?>"><li class="active"> <?php echo $_GET['campaign']; ?> </li></a>
    </ul>
</div>

<table id="report_content" class="table table-striped">
    <thead>
        <tr>
            <th>Content</th>
            <th>Visits</th>
