...
<div class="header" style="padding:30px 0px; height:auto;">
    <ul class="nav nav-wizard" style="margin:0px;">
        ...
        <a href="?page=sh_reports_page&action=report-medium&source=<?php echo $_GET['source']; ?>"><li> <?php echo $_GET['medium']; ?> </li></a>
        <a href="?page=sh_reports_page&action=report-campaign&source=<?php echo $_GET['source']; ?>&medium=<?php echo $_GET['medium']; ?>"><li> <?php echo $_GET['campaign']; ?> </li></a>
        <a href="?page=sh_reports_page&action=report-content&source=<?php echo $_GET['source']; ?>&medium=<?php echo $_GET['medium']; ?>&campaign=<?php echo $_GET['campaign']; ?>"><li class="active"> <?php echo $_GET['content']; ?> </li></a>
    </ul>
</div>

<table id="report_term" class="table table-striped">
    <thead>
        <tr>
            <th>Term</th>
            <th>Visits</th>
